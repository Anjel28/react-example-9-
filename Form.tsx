...
const Form :React.FC = () => {
 ...
 <div>
  ...
  <div className="mb-3">
    ...
    <input type="firstName" name="firstName" value={state.user.firstName} onChange={handleChange}className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
   ...
   <div className="mb-3">
    ...
    <input type="firstName" name="lastName" value={state.user.lastName} onChange={handleChange}className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" />
